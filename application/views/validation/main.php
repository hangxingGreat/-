...
<html lang="zh-cn">
  <head>
    ...
    $(document).ready(function(){
      ...
      {
        $.get("<?=site_url('validationmanage/show')?>",function(data,status){
          $("#detail").html(data);
        });
      });
  ...
  <body>
    ...
    <div class="container">
      <div class="row">
        <h3 class="text-center">鉴定验收情况信息维护</h3>
        ...
        <div class="col-md-1 col-md-offset-10 text-right">
          <form action="<?=site_url('modecontroller/changemode')?>" method="post" id="modeControl">
            ...
            <input type="text" name="from" value="<?=site_url('validationmanage/index')?>" hidden>
          </form>
        </div>
      </div>
      <hr/>
              ...
              <div class="modal-content">
                ...
                <div class="modal-body">
                      <form class="form-horizontal">
                          ...
                          <div class="form-group">
                            <label for="inputInstitute" class="col-sm-3 control-label">鉴定机构</label>
                            <div class="col-sm-6">
                              <input type="text" class="form-control" id="inputInstitute">
                            </div>
                          </div>
                          <div class="form-group">
                            <label for="inputTime" class="col-sm-3 control-label">鉴定时间</label>
                            <div class="col-sm-6">
